...
export default function EmptyState({ title, description, action, icon }) {
  return (
    ...
    >
      ...
      <h3 className="font-headline-md text-headline-md text-ink-800 dark:text-inverse-on-surface">{title}</h3>
      {description ? (
        <p className="mt-2 font-body-md text-body-md text-ink-600 dark:text-outline">{description}</p>
      ) : null}
